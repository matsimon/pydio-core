...
"Configurations storage" => "&lt;span class='icon-save'&gt;&lt;/span&gt; Configuration storage",
...
"User-friendly name of the user" => "Name that other users will see",
"Admin Password" => "Admin Password",
"Use a strong password (more than 8 characters, complicated ones." => "Use a strong password (more than 8 characters, no dictionary words etc.",
"Confirm" => "Confirm",
"Confirm password" => "Confirm password",
"Test Mailer" => "Test Mailer",
"Try sending an email with the configured data" => "Try sending an email with the configured data",
"Test SQL Connexion" => "Test SQL Connection",
...
"Database (Requires MySQL, PostgreSQL or SQLite)" => "Database system (production environments, requires a DBMS supported by APPLICATION_TITLE)",
