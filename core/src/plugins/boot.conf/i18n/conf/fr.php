...
"Use a strong password (more than 8 characters, complicated ones." => "Utiliser un mot de passe fort (plus de 8 caractères, pas de mots du dictionnaire etc.)",
"Confirm" => "Confirmer",
...
"Database (Requires MySQL, PostgreSQL or SQLite)" => "Base de Données (environnements productifs)",
